...
// EEPROM Default values
  ...
  #define DEFAULT_Z_SCALE 5.0  // Trick um f�r Z kleineren Vorschub zu erzwingen
  ...
  // No Z Scaling.
  #define DEFAULT_Z_SCALE 1.0  // Trick um f�r Z kleineren Vorschub zu erzwingen
  #define DEFAULT_Z_GAUGE 10.0 // mm, Z Gauge Block Dicke
  #define DEFAULT_Z_PULLOFF 0.0 // mm, auto pull back Z after pressing ZERO center btn
...
#define JOG_MAX_SPEED   8000  // Hz, gr��te Schrittgeschwindigkeit
#define JOG_RAMP        5     // Ramp speed inc/dec in �s per loop (higher=faster)
